...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private Map<String, Object> handleExceptionResponse(Throwable exception, HttpServletRequest request) {
        return getStringObjectMap(Collections.singleton(exception.getMessage()), request.getMethod(), request.getRequestURI());
    }

    public Map<String, Object> getStringObjectMap(Collection<String> messages, String method, String endpoint) {
